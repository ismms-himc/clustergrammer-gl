module.exports = function run_zoom_restrictions(
  zd,
  ptp,
  viz_dim_heat,
  zd_copy
  ...
  */
  ...
  if (ptp.min > zero_threshold) {
    ...
    zd.pan_by_zoom =
      ...
      zd.total_pan_min * zd.total_zoom;
    ...
    var new_cursor_relative_max =
      viz_dim_heat.max - viz_dim_heat.min + zd.viz_offcenter;
  ...
  if (ptp.max > zero_threshold) {
    ...
    zd.pan_by_zoom =
      ...
      zd.total_pan_max * zd.total_zoom;
    ...
    var new_cursor_relative_min =
      viz_dim_heat.max + zd.heat_offset - viz_dim_heat.min + zd.viz_offcenter;
