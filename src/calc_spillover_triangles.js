module.exports = function calc_spillover_triangles(params){
  ...
  var scaled_height = mat_size.x / height_to_width;
  ...
  spillover_triangles.mat = [
    ...
    // top spillover rect
    {'pos': [[-mat_size.x, 1], [-mat_size.x, scaled_height], [mat_size.x, 1]]},
    {'pos': [[ mat_size.x, 1], [mat_size.x, scaled_height], [-mat_size.x, scaled_height]]},
  ...
  spillover_triangles.corners = [
    ...
    {'pos': [[-1, 1], [-mat_size.x, scaled_height], [-1.0, scaled_height]]},
    {'pos': [[-1, 1], [-mat_size.x,  1], [-mat_size.x, scaled_height]]},
