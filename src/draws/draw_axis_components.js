module.exports = function draw_axis_components(regl, params, inst_axis, calc_text_tri=false){
  ...
  params.cameras[inst_axis + '-labels'].draw(() => {
    ...
    // viz aid triangles
    params.viz_aid_tri_args[inst_axis] = require('./../matrix_labels/make_viz_aid_tri_args')(regl, params, inst_axis);
    ...
    if (inst_axis === 'col'){
      text_triangle_args = require('./../matrix_labels/make_col_text_args')(regl,
                                        params, params.zoom_data.zoom_function);
    } else {
      text_triangle_args = require('./../matrix_labels/make_row_text_args')(regl,
                                        params, params.zoom_data.zoom_function);
    }
