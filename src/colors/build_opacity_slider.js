...
module.exports = function build_opacity_slider(cgm, axis){
  ...
  var slider_group = d3.select(params.root + ' .'+ axis +'_dendro_slider_svg')
      .append('g')
  ...
  function click_dendro_slider(){
    ...
    d3.select(params.root+ ' .'+axis+'_group_circle')
